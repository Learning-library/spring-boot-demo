...
public class QuartzConfig {
    ...
    public Properties quartzProperties() throws IOException {
        ...
        prop.put("org.quartz.dataSource.quartzDataSource.URL", "jdbc:mysql://103.37.124.108:3306/demo-schema");
        prop.put("org.quartz.dataSource.quartzDataSource.user", "root");
        prop.put("org.quartz.dataSource.quartzDataSource.password", "changdaye");
